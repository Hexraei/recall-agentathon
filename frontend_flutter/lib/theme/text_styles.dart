...
class AppText {
  ...
  static TextStyle get lockup =>
      _serif(size: 46, letterSpacing: -0.5);

  /// Large result figures — a student's score, a class percentage.
  static TextStyle get displayResult =>
      _serif(size: 34, letterSpacing: -0.6);

  static TextStyle get resultFigure =>
      _serif(size: 30, letterSpacing: -0.5);

  /// The standard page title on an inner screen.
  static TextStyle get pageTitle =>
      _serif(size: 27, letterSpacing: -0.4);

  static TextStyle get sectionTitle =>
      _serif(size: 24, letterSpacing: -0.3);

  /// Sheet and dialog headings.
  static TextStyle get sheetTitle =>
      _serif(size: 21, letterSpacing: -0.2);

  static TextStyle get dialogTitle =>
      _serif(size: 22, letterSpacing: -0.2);
  ...
  static TextStyle get statFigure =>
      _serif(size: 28, letterSpacing: -0.4);
  ...
  static TextStyle get caption =>
      _sans(size: 12, color: AppColors.grey3);

  static TextStyle get captionSmall =>
      _sans(size: 11, color: AppColors.grey3);
  ...
  static TextStyle get optionTextSelected =>
      _sans(size: 14.5, height: 20, weight: FontWeight.w600, color: AppColors.ink);
}
